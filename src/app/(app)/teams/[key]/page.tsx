...
import { Settings2, Lock, BarChart3, Building2 } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/teams/${team.team_key}/colleges`} className="btn btn-outline btn-md"><Building2 className="h-4 w-4" /> Colleges</Link>
